									...
									<div id="step-1">
										<div class="row">
											...
											<div class="col-md-6 form-step-0" role="form" data-toggle="validator">
												...
												<div class="form-group">
													<?php $field='agama'; ?>
													<label for="<?=$field?>">Agama / Kepercayaan<?=$sess[11]?></label>
													<select name="<?=$field?>" id="<?=$field?>" class="form-control" required>
														<option value="">Pilih</option>
														<option value="islam" <?php if($sess[11]=='islam'){echo 'selected';}?>>Islam</option>
														<option value="kristen" <?php if($sess[11]=='kristen'){echo 'selected';}?>>Kristen</option>
														<option value="hindu" <?php if($sess[11]=='hindu'){echo 'selected';}?>>Hindu</option>
														<option value="budha" <?php if($sess[11]=='budha'){echo 'selected';}?>>Budha</option>
														<option value="konghucu" <?php if($sess[11]=='konghucu'){echo 'selected';}?>>Konghucu</option>
													</select>
													<div class="help-block with-errors"></div>
												</div>

...
<div class="main-content">
    <div class="dashboard-area">
        ...
        <h4 class="card-title">Management Wali Siswa</h4>
			<!-- add data -->
                        ...
                        <fieldset>
							...
							<div class="col-6 col-sm-6">
									<div class="form-group row">
										...
										<input type="text" id="_txtNmWali" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
									...
									<div class="form-group row">
										...
										<input type="text" id="_txtPnd" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
								<div class="col-6 col-sm-6">
									<div class="form-group row">
										...
										<input type="text" id="_txtPkj" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Penghasilan Bulanan</label>
										<input type="text" id="_txtPengBln" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Kebutuhan Khusus</label>
										<input type="text" id="_txtKebK" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Hubungan</label>
										<input type="text" id="_txtHub" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
                            ...
                            <div class="row" style="padding-right: 15px;">
								<div class="col-6 col-sm-6">
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Nama Wali</label>
										<input type="hidden" id="txtId">
										<input type="text" id="txtNmWali" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Pendidikan</label>
										<input type="text" id="txtPnd" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
								<div class="col-6 col-sm-6">
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Pekerjaan</label>
										<input type="text" id="txtPkj" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Penghasilan Bulanan</label>
										<input type="text" id="txtPengBln" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Kebutuhan Khusus</label>
										<input type="text" id="txtKebK" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Hubungan</label>
										<input type="text" id="txtHub" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
...
// 	});
    ...
    function load_data(page,data={}) {
		// alert('test');
	    $.ajax({
		    url       : "<?=base_url()?>sekolah/getSiswaWaliFilter/get/"+page,
		    method    : "POST",
		    data      : data,
		    dataType  : "JSON",
	...
	function edit(id){
		if(id==null){
			...
			$.ajax({
		    url       : "<?=base_url()?>sekolah/getSiswaWaliData/",
		    method    : "POST",
		    data      : {'id':id},
		    dataType  : "JSON",
		    // beforeSend: function() {$('body').append('<div class="first-loader"><img src="'+img+'spin.svg"></div>')},
		    ...
		    success   : function(data) {
				...
				$("#txtNmWali").val(data.result.nama);
				$("#txtTglLh").val(data.result.thn_lahir);
				$("#txtNik").val(data.result.nik);
				$("#txtPnd").val(data.result.pendidikan);
				$("#txtPkj").val(data.result.pekerjaan);
				$("#txtPengBln").val(data.result.penghasilan_bulanan);
				$("#txtKebK").val(data.result.kebutuhan_khusus);
				$("#txtHub").val(data.result.hubungan);
	...
	$("#dataUpdtForm").on("submit", function (e) {
		e.preventDefault();
		var valId = $("#txtId").val();
		var valNmWali = $("#txtNmWali").val();
		var valTglLh = $("#txtTglLh").val();
		var valNik = $("#txtNik").val();
		var valPnd = $("#txtPnd").val();
		var valPkj = $("#txtPkj").val();
		var valPengBln = $("#txtPengBln").val();
		var valKebK = $("#txtKebK").val();
		var valHub = $("#txtHub").val();
		$.ajax({
		    url       : "<?=base_url()?>sekolah/updateSiswaWali/",
		    method    : "POST",
		    data      : {
				'_valId':valId,
				'_valNmWali':valNmWali,
				'_valTglLh':valTglLh,
				'_valNik':valNik,
				'_valPnd':valPnd,
				'_valPkj':valPkj,
				'_valPengBln':valPengBln,
				'_valKebK':valKebK,
				'_valHub':valHub,
			},
		    dataType  : "JSON",
	...
	function hapus(id){
		...
		Swal.fire({
			...
			if (t.value) {
				$.ajax({
					url       : "<?=base_url()?>sekolah/deleteSiswaWali/",
					method    : "POST",
					data      : {'id':id},
					dataType  : "JSON",
					// beforeSend: function() {$('body').append('<div class="first-loader"><img src="'+img+'spin.svg"></div>')},
	...
	function detail(id){
		$.ajax({
		    ...
		    success   : function(data) {
				...
				$("#txtNmWali_").val(data.result.nama);
				$("#txtTglLh_").val(data.result.thn_lahir);
				$("#txtNik_").val(data.result.nik);
				$("#txtPnd_").val(data.result.pendidikan);
				$("#txtPkj_").val(data.result.pekerjaan);
				$("#txtPengBln_").val(data.result.penghasilan_bulanan);
				$("#txtKebK_").val(data.result.kebutuhan_khusus);
				$("#txtHub_").val(data.result.hubungan);

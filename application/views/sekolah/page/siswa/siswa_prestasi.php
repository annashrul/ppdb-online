...
<div class="main-content">
    <div class="dashboard-area">
        ...
        <h4 class="card-title">Management Prestasi Siswa</h4>
			<!-- add data -->
                            ...
                            <div class="row" style="padding-right: 15px;">
								<div class="col-6 col-sm-6">
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Nama Prestasi</label>
										<input type="hidden" id="_txtId">
										<input type="text" id="_txtNmPres" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="" readonly="true">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Tingkat</label>
										<input type="text" id="_txtTkt" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="" readonly="true">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
								<div class="col-6 col-sm-6">
									<div class="form-group row">
										...
										<input type="text" id="_txtThn" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="" readonly="true">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Penyelenggara</label>
										<input type="text" id="_txtPenye" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="" readonly="true">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
                        ...
                        <fieldset>
							...
							<div class="col-6 col-sm-6">
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Nama Prestasi</label>
										<input type="hidden" id="txtId">
										<input type="text" id="txtNmPres" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Tingkat</label>
										<input type="text" id="txtTkt" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
								<div class="col-6 col-sm-6">
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Tahun</label>
										<input type="text" id="txtThn" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
									<div class="form-group row">
										<label class="col-4 col-sm-4 text-left">Penyelenggara</label>
										<input type="text" id="txtPenye" class="form-control col-8 col-sm-8" aria-describedby=""
											placeholder="">
										<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
									</div>
								</div>
							...
							<table id="basic-datatable" class="table dt-responsive nowrap w-100">
								<thead class="primary-color">
									<tr>
										...
										<th class="text-white">TINGKAT</th>
				...
				<div class="row" style="padding-right: 15px;">
					<div class="col-6 col-sm-6">
						<div class="form-group row">
							...
							<input type="text" id="txtNmPres_" class="form-control col-8 col-sm-8" aria-describedby=""
								placeholder="" readonly="true">
							<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
						</div>
						<div class="form-group row">
							<label class="col-4 col-sm-4 text-left">Tingkat</label>
							<input type="text" id="txtTkt_" class="form-control col-8 col-sm-8" aria-describedby=""
								placeholder="" readonly="true">
							<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
						</div>
					</div>
					<div class="col-6 col-sm-6">
						<div class="form-group row">
							<label class="col-4 col-sm-4 text-left">Tahun</label>
							<input type="text" id="txtThn_" class="form-control col-8 col-sm-8" aria-describedby=""
								placeholder="" readonly="true">
							<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
						</div>
						<div class="form-group row">
							<label class="col-4 col-sm-4 text-left">Penyelenggara</label>
							<input type="text" id="txtPenye_" class="form-control col-8 col-sm-8" aria-describedby=""
								placeholder="" readonly="true">
							<div class="invalid-feedback col-8 col-sm-8 offset-4">Harus di isi!</div>
						</div>
					</div>
...
// 	});
    ...
    function load_data(page,data={}) {
		// alert('test');
	    $.ajax({
		    url       : "<?=base_url()?>sekolah/getSiswaPrestasiFilter/get/"+page,
		    method    : "POST",
		    data      : data,
		    dataType  : "JSON",
	...
	function edit(id){
		if(id==null){
			...
			$.ajax({
		    url       : "<?=base_url()?>sekolah/getSiswaPrestasiData/",
		    method    : "POST",
		    data      : {'id':id},
		    dataType  : "JSON",
		    // beforeSend: function() {$('body').append('<div class="first-loader"><img src="'+img+'spin.svg"></div>')},
		    ...
		    success   : function(data) {
				...
				$("#txtNmPres").val(data.result.title);
				$("#txtTkt").val(data.result.tingkat);
				$("#txtThn").val(data.result.tahun);
				$("#txtPenye").val(data.result.penyelenggara);
	...
	$("#dataUpdtForm").on("submit", function (e) {
		e.preventDefault();
		var valId = $("#txtId").val();
		var valNmPres = $("#txtNmPres").val();
		var valTkt = $("#txtTkt").val();
		var valThn = $("#txtThn").val();
		var valPenye = $("#txtPenye").val();
		$.ajax({
		    url       : "<?=base_url()?>sekolah/updateSiswaPrestasi/",
		    method    : "POST",
		    data      : {
				'_valId':valId,
				'_valNmPres':valNmPres,
				'_valTkt':valTkt,
				'_valThn':valThn,
				'_valPenye':valPenye,
			},
	...
	function hapus(id){
		...
		Swal.fire({
			...
			if (t.value) {
				$.ajax({
					url       : "<?=base_url()?>sekolah/deleteSiswaPrestasi/",
					method    : "POST",
					data      : {'id':id},
					dataType  : "JSON",
					// beforeSend: function() {$('body').append('<div class="first-loader"><img src="'+img+'spin.svg"></div>')},
	...
	function detail(id){
		$.ajax({
		    ...
		    success   : function(data) {
				...
				$("#txtNmPres_").val(data.result.title);
				$("#txtTkt_").val(data.result.tingkat);
				$("#txtThn_").val(data.result.tahun);
				$("#txtPenye_").val(data.result.penyelenggara);

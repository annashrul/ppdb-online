					...
					<div class="card-body">
						...
						<form id="msform">
							...
							<ul id="progressbar">
								...
								<li id="payment"><strong>Orang Tua / Wali</strong></li>
								<li id="fourStep"><strong>Tambahan</strong></li>
								<li id="confirm"><strong>Prestasi</strong></li>
							</ul>
							<div class="progress">
